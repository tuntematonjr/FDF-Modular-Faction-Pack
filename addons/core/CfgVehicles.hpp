class CfgVehicles {
	...
	class KAR_FDF_BASE_01: B_Soldier_base_F {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_NCU_CA.PAA);
		scope = 1;
	};
	...
	class KAR_FDF_BASE_08: KAR_FDF_BASE_01 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_CRYE_GEN3_CA.PAA);
	};
	class KAR_FDF_BASE_11: KAR_FDF_BASE_08 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_CRYE_GEN3_M04_CA.paa);
	};
	...
	class KAR_FDF_BASE_16: KAR_FDF_BASE_04 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_GORKA_SW_CA.PAA);
	};
	class KAR_FDF_BASE_18: KAR_FDF_BASE_01 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_M62_PALVELUS_CA.PAA);
	};
	class KAR_FDF_BASE_19: KAR_FDF_BASE_01 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_M62_MAASTOPUKU_HIHAT_CA.PAA);
	};
	class KAR_FDF_BASE_20: KAR_FDF_BASE_01 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_M62_MAASTOTAKKI_CA.PAA);
	};
	class KAR_FDF_BASE_21: KAR_FDF_BASE_01 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_TALVIPUKU_CA.PAA);
	};
	class KAR_FDF_BASE_22: KAR_FDF_BASE_18 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_M05_PALVELUS_CA.PAA);
	};
	class KAR_FDF_BASE_23: KAR_FDF_BASE_19 {
		...
		//picture = QPATHTOF(ui\icons\KAR_FDF_M05_MAASTOPUKU_HIHAT_CA.PAA);
	};
	class KAR_FDF_BASE_24: KAR_FDF_BASE_07 {
		hiddenSelectionsTextures[] = {QPATHTOF(data\M05_taistelupaita_co.paa)};
		model = "\A3\Characters_F_Exp\BLUFOR\B_CTRG_Soldier_03_F.p3d";
		//picture = QPATHTOF(ui\icons\KAR_FDF_M05_TAISTELUPAITA_SLEEVE_CA.PAA);
	};
	/////BACKPACKS/////
	class B_Kitbag_Base;
	class KAR_FDF_BAG_01: B_Kitbag_Base {
		...
		picture = QPATHTOF(ui\icons\backpacks\KAR_FDF_BAG_01_CA.PAA);
		scope = 2;
		scopeCurator = 2;
	};
	class KAR_FDF_Kitbag_01: KAR_FDF_BAG_01 {
		...
		picture = QPATHTOF(ui\icons\backpacks\KAR_FDF_KITBAG_01_CA.PAA);
	};
	class KAR_FDF_Kitbag_02: KAR_FDF_BAG_01 {
		...
		model = "\A3\weapons_f\Ammoboxes\bags\Backpack_Fast";
		picture = QPATHTOF(ui\icons\backpacks\KAR_FDF_KITBAG_02_CA.PAA);
	};
	class KAR_FDF_Kitbag_03: KAR_FDF_BAG_01 {
		...
		model = "\A3\weapons_f\Ammoboxes\bags\Backpack_Fast";
		picture = QPATHTOF(ui\icons\backpacks\KAR_FDF_KITBAG_03_CA.PAA);
	};
	class KAR_FDF_Kitbag_04: KAR_FDF_BAG_01 {
		...
		model = "\A3\weapons_f\Ammoboxes\bags\Backpack_Fast";
		picture = QPATHTOF(ui\icons\backpacks\KAR_FDF_KITBAG_04_CA.PAA);
	};
};
